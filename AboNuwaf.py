                        ...
                        for t in reversed(sorted(ch_night_r.keys())):
                            if t not in night_disabled_r:
                                ...
                                if isinstance(entry, dict) and entry.get("url"):
                                    ...
                                    restore_btype = "night"
                                    break
                if restore_station and not ch_data.get("externally_stopped", False):
                    try:
                    ...
                    logger.info(f"Skipping restore for {channel_id} — has schedule but no station found or externally_stopped")
                continue
